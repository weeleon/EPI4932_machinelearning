...
#here is a small guidance to help you install CARET if you are using R commands and/or scripting
#
setPath <- 'C:/Users/leonard.wee/OneDrive - Maastro - Clinic/Bureaublad/machine_learning_in_R'
...
ive_rf <- shapper::individual_variable_effect(
  ...
  data = dplyr::select(svm_TRAIN, -mortality),  #the dataset BUT WITHOUT THE OUTCOME!
